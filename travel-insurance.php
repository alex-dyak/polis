...
<main class="page">
		...
		<div class="hero-page__content">
			<div class="hero-page__container">
				<div class="hero-page__body">
					...
					<div class="hero-page__form form-calculate form-calculate-travel">
	...
	<section class="travel-packages mb-170">
		<div class="travel-packages__container">
			<div class="travel-packages__content">
				<div class="travel-packages__header">
					<h2 class="h2 travel-packages__title title-center">
						Пакети туристичних полісів
					</h2>
				</div>
				<?php if( have_rows('packets') ): ?>
					<div class="travel-packages__columns">
						<?php while( have_rows('packets') ): the_row(); ?>
							<div class="travel-packages__package package package--basic">
								<div class="package__body">
									<div class="package__header">
										<h4 class="h4 mb-30">
											<?php the_sub_field('title');?>
										</h4>
										<span class="color-green font-size-21">
											<b>
				...
				<?php endif; ?>
				<div class="travel-packages__text">
					<p>
						<?php pll_e("Невідкладна медична допомога включає в себе : Невідкладна медична допомога,невідкладне стаціонарне лікування,невідкладне амбулаторне лікування,невідкладна стоматологічна допомога");?>
					</p>
				</div>
			</div>
		</div>
