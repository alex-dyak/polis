		...
		<div class="hero-page__content">
			<div class="hero-page__container">
				<div class="hero-page__body">
					...
					<div class="hero-page__form form-calculate">
                ...
                <div class="benefits__container">
                    <div class="benefits__content">
                        <div class="benefits__columns">
                            <div class="benefits__left" <?php if(get_field('lined_list')): echo 'insurance-protect__right'; endif; ?>>
                                <h4 class="h4 benefits__title mb-30">
			                        <?php the_sub_field('title');?>
                                </h4>
                                <?php if(get_sub_field('help_text')): ?>
                                    <span style="display: inline-block;" class="color-green font-size-21 mb-30">
                                        <b><?php the_sub_field("help_text");?></b>
                                    </span>
                                <?php endif;?>
		                        <?php if(get_field('numbered_list')): ?>
                                <ol>
			                        <?php elseif(get_field('lined_list')): ?>
                                    <ul>
				                        <?php else: ?>
                                        <ul class="icon--big">
					                        <?php endif; ?>
